...
export const SPT: Array<MapperSeeder> = [
  ...
  },
  {
    ...
    size: 1,
    end_char: 65,
    field: 'special_agreement_indicator',
    description: 'Special Agreement Indicator',
    is_required: false,
  },
  {
    version,
    ...
    size: 1,
    end_char: 66,
    field: 'first_recording_refusal_indicator',
    description: 'First Recording Refusal Indicator',
    is_required: false,
  },
  {
    version,
